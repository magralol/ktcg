    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <select class="form-select mb-3" v-model="weaponType">
            <option value="existing">Existing</option>
            <option value="new">New</option>
          </select>

          <div v-show="weaponType == 'existing'">
            <input type="text" class="form-control  mb-3" placeholder="Fitler..." aria-label="Filter">
            <ul class="list-group">
              <li class="list-group-item mb-2 d-flex justify-content-between align-items-center" style="border-top: 1px #ddd solid; cursor: pointer;" v-for="weapon in store.getWeapons(props.rosterId)" @click="onClose(weapon.id)">
                <div>
          ...
          <WeaponForm v-show="weaponType == 'new'"  :rosterId="props.rosterId" @onComplete="onClose"/>
...
<script setup>
  ...
  function onClose(weaponid){
    weaponType.value = "existing";
    emit('onClose', weaponid);
  }
